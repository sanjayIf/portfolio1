    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        >
          ...
          >
            <span className="text-gradient-cyan">{bio.name}</span>
            <br />
            <span className="text-3xl md:text-4xl lg:text-5xl font-semibold text-foreground/90">
              {bio.title}
            </span>
          </motion.h1>
          ...
          >
            <Button
              ...
              className="bg-primary text-primary-foreground hover:bg-primary/90 glow-cyan font-semibold text-lg px-8 py-6"
            >
              View Work
            </Button>
            <Button
